...
SUPPORTED_DATASETS = {
    'URL': 'http://oneflow-public.oss-cn-beijing.aliyuncs.com/datasets/FlowText/IWSLT2016/2016-01.tgz',
    '_PATH': '2016-01.tgz',
...
def IWSLT2016(root='.data', split=('train', 'valid', 'test'), language_pair=('de', 'en'), valid_set='tst2013', test_set='tst2014'):
    ...
    **valid/test sets**: ['dev2010', 'tst2010', 'tst2011', 'tst2012', 'tst2013', 'tst2014']
    ...
    Examples:
        >>> from flowtext.datasets import IWSLT2016
    ...
    dataset_tar = download_from_url(SUPPORTED_DATASETS['URL'], root=root,

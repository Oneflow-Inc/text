...
SUPPORTED_DATASETS = {
    ...
    'URL': 'http://oneflow-public.oss-cn-beijing.aliyuncs.com/datasets/FlowText/IWSLT2017/2017-01-trnmted.tgz',
...
def IWSLT2017(root='.data', split=('train', 'valid', 'test'), language_pair=('de', 'en')):
    ...
    **Language pairs**:
    ...
    Examples:
        >>> from flowtext.datasets import IWSLT2017
    ...
    dataset_tar = download_from_url(SUPPORTED_DATASETS['URL'], root=root, path=os.path.join(root, SUPPORTED_DATASETS['_PATH']))

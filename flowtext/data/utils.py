...
def get_tokenizer(tokenizer, language="en"):
    ...
    Args:
        tokenizer: the name of tokenizer function. If None, it returns split()
            ...
            (e.g. spacy, moses, toktok, revtok, subword, jieba), it returns the
    ...
    if tokenizer == "spacy":
        ...
        try:
            ...
            return partial(jieba.lcut, cut_all=False, HMM=True)
        except ImportError:
            print("Please install jieba.")
            raise
    ...
    raise ValueError(
        ...
        '"moses" for the NLTK port of the Moses tokenization script,'
        '"jieba" for the jieba Chinese tokenizer.'.format(tokenizer)
    )
...
def dtype_to_attr(dtype):
    # convert flow.dtype to dtype string id
    # e.g. flow.int32 -> "int32"
